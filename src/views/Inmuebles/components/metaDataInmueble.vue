<template>
	<div class=" container__dataInmueble">
		<div class="metaInmueble">
			...
			<div class="detalleInmueble">
				<div class="detalleInmueble__container">
					<div class="wrapperDetalleInmueble">
							<h2 class="tituloDetalleInmueble">Descripción Inmueble</h2>
							<div class="wrapperDetalleInmueble__data">
					...
					<div class="wrapperDetalleInmueble areaGeneral">
...
.detalleInmueble__container{
	display: flex;
	gap: 1rem;
	justify-content: space-around;
}
.wrapperDetalleInmueble{
	width: 50%;
}

.wrapperDetalleInmueble__data{
	width: 100%;
}
